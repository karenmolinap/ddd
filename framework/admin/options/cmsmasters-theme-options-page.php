...
if (!function_exists('good_food_get_custom_page_meta_fields')) {
function good_food_get_custom_page_meta_fields() {
	$cmsmasters_option = good_food_get_global_options();
	
	
	$cmsmasters_global_layout = (isset($cmsmasters_option['good-food' . '_layout']) && $cmsmasters_option['good-food' . '_layout'] !== '') ? $cmsmasters_option['good-food' . '_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_header_overlaps = (isset($cmsmasters_option['good-food' . '_header_overlaps']) && $cmsmasters_option['good-food' . '_header_overlaps'] !== '') ? (($cmsmasters_option['good-food' . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'good-food'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'good-food'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'good-food'), 
