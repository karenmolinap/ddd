...
if (!function_exists('good_food_get_custom_post_meta_fields')) {
function good_food_get_custom_post_meta_fields() {
	$cmsmasters_option = good_food_get_global_options();
	
	
	$cmsmasters_global_blog_post_layout = (isset($cmsmasters_option['good-food' . '_blog_post_layout']) && $cmsmasters_option['good-food' . '_blog_post_layout'] !== '') ? $cmsmasters_option['good-food' . '_blog_post_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_blog_post_title = (isset($cmsmasters_option['good-food' . '_blog_post_title']) && $cmsmasters_option['good-food' . '_blog_post_title'] !== '') ? (($cmsmasters_option['good-food' . '_blog_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_share_box = (isset($cmsmasters_option['good-food' . '_blog_post_share_box']) && $cmsmasters_option['good-food' . '_blog_post_share_box'] !== '') ? (($cmsmasters_option['good-food' . '_blog_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_author_box = (isset($cmsmasters_option['good-food' . '_blog_post_author_box']) && $cmsmasters_option['good-food' . '_blog_post_author_box'] !== '') ? (($cmsmasters_option['good-food' . '_blog_post_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_more_posts_box = (isset($cmsmasters_option['good-food' . '_blog_more_posts_box'])) ? $cmsmasters_option['good-food' . '_blog_more_posts_box'] : 'related';
	...
	$tabs_array['cmsmasters_post'] = array( 
		'label' => esc_html__('Post', 'good-food'), 
	...
	$custom_post_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Post', 'good-food'), 
		...
		array( 
			'label'	=> esc_html__('Post Image', 'good-food'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Gallery', 'good-food'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Audio Links', 'good-food'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Title', 'good-food'), 
		...
		array( 
			'label'	=> esc_html__("'Read More' Buttons Text", 'good-food'), 
			'desc'	=> esc_html__("Enter the 'Read More' button text that should be used in you blog shortcode", 'good-food'), 
			'id'	=> $cmsmasters_option_name . 'read_more', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('Read More', 'good-food') 
		), 
		array( 
			'id'	=> 'cmsmasters_post', 
			'type'	=> 'tab_finish' 
		...
		array( 
			'label'	=> esc_html__('Page Layout', 'good-food'), 
			'desc'	=> '</br>' . esc_html__('Choosing layout with a sidebar please make sure to add widgets in the Appearance - Widgets tab. The empty sidebar won\'t be displayed.', 'good-food'), 
			'id'	=> 'cmsmasters_layout', 
			'type'	=> 'radio_img', 
			'hide'	=> '', 
			...
			'options' => array( 
				'r_sidebar' => array( 
					...
					'label' => esc_html__('Right Sidebar', 'good-food'), 
					'value'	=> 'r_sidebar' 
				), 
				'l_sidebar' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/sidebar_l.jpg', 
					'label' => esc_html__('Left Sidebar', 'good-food'), 
					'value'	=> 'l_sidebar' 
				), 
				'fullwidth' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/fullwidth.jpg', 
					'label' => esc_html__('Full Width', 'good-food'), 
					'value'	=> 'fullwidth' 
				) 
			) 
		), 
		array( 
			'label'	=> esc_html__('Choose Right\Left Sidebar', 'good-food'), 
			'desc'	=> '', 
