...
$form_fields =  array( 
	'author' => '<p class="comment-form-author">' . "\n" . 
		'<label for="author">' . esc_html__('Name', 'good-food') . (($req) ? '<span class="cmsmasters_req">*</span>' : '') . '</label>' . "\n" . 
	...
	'cookies' => '<p class="comment-form-cookies-consent">' . "\n" . 
		...
		'<label for="wp-comment-cookies-consent">' . esc_html__('Save my name, email, and website in this browser for the next time I comment.', 'good-food') . '</label>' . "\n" . 
	'</p>' . "\n" 
);
...
comment_form(array( 
	...
	'comment_field' => 		'<p class="comment-form-comment">' . 
								'<label for="comment">' . esc_html__('Comment', 'good-food') . '</label>' . 
	...
	'logged_in_as' => 		'<p class="logged-in-as">' . 
								esc_html__('Logged in as', 'good-food') . 
	...
	'comment_notes_before' => 	'<p class="comment-notes">' . 
									esc_html__('Your email address will not be published.', 'good-food') . 
								'</p>' . "\n", 
	'comment_notes_after' => 	'', 
	'id_form' => 				'commentform', 
	'id_submit' => 				'submit', 
	'title_reply' => 			esc_html__('Leave a Reply', 'good-food'), 
	'title_reply_to' => 		esc_html__('Leave your comment to', 'good-food'), 
	'cancel_reply_link' => 		esc_html__('Cancel Reply', 'good-food'), 
	'label_submit' => 			esc_html__('Add Comment', 'good-food') 
));
