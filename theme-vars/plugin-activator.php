...
function good_food_register_theme_plugins() { 
	$plugins = array( 
		...
		array( 
			'name'					=> esc_html__('CMSMasters Custom Fonts', 'good-food'), 
		...
		array( 
			'name'					=> esc_html__('CMSMasters Importer', 'good-food'), 
		...
		array( 
			'name'					=> esc_html__('Envato Market', 'good-food'), 
			'slug'					=> 'envato-market', 
			'source'				=> 'https://envato.github.io/wp-envato-market/dist/envato-market.zip', 
			'required'				=> false 
		), 
		array( 
			'name'					=> esc_html__('GDPR Cookie Consent', 'good-food'), 
		...
		array( 
			'name'					=> esc_html__('MailPoet 3', 'good-food'), 
			'slug'					=> 'mailpoet', 
			'required'				=> false 
		), 
		array( 
