...
function good_food_woocommerce_register_styles_scripts() {
	...
	$cmsmasters_image_sizes = good_food_get_image_thumbnail_list();
...
function good_food_woocommerce_demo_store($html, $notice) {
...
add_filter('woocommerce_demo_store', 'good_food_woocommerce_demo_store', 10, 2);


function good_food_woocommerce_support() {
...
add_action('after_setup_theme', 'good_food_woocommerce_support');
